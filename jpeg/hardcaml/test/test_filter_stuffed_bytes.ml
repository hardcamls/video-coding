...
let step_test steps =
  ...
  Waveform.print ~wave_width:2 ~display_width:110 ~display_height:46 ~display_rules waves
;;
...
let%expect_test "zeros and stuffing" =
  ...
  [%expect
    ...
    (r (0x0 0x0 0x0 0x0 0xff 0xff 0x0 0x0))
    ("got invalid output length" (length_d 11) (length_r 8))
    ("byte mismatch" (i 5) ("d.(i)" 0x0) ("r.(i)" 0xff))
    ("byte mismatch" (i 6) ("d.(i)" 0xff) ("r.(i)" 0x0))
    ┌Signals───────────┐┌Waves───────────────────────────────────────────────────────────────────────────────────┐
    │clock             ││┌──┐  ┌──┐  ┌──┐  ┌──┐  ┌──┐  ┌──┐  ┌──┐  ┌──┐  ┌──┐  ┌──┐  ┌──┐  ┌──┐  ┌──┐  ┌──┐  ┌──┐│
    │                  ││   └──┘  └──┘  └──┘  └──┘  └──┘  └──┘  └──┘  └──┘  └──┘  └──┘  └──┘  └──┘  └──┘  └──┘  └│
    │clear             ││──────┐                                                                                 │
