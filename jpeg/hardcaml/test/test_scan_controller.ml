...
let%expect_test "420 48x48" =
  ...
  [%expect
    ...
    ((scan_index 1) (x_pos 32) (y_pos 16))
    ((scan_index 2) (x_pos 16) (y_pos 8))
    ((scan_index 0) (x_pos 16) (y_pos 8))
